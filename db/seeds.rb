...
Quetion.create(title: '会社の先輩、上司、お客様などに、依頼しなければならない事ができました。あなたならどうする？',
  ...
  point1:2, point2:0, point3:1, category:'kaiwa' ,note:'クッション言葉を入れる事で、相手への印象を柔らかくすることができます。')
#2
Quetion.create(title: 'お客様自社の事を説明するように頼まれました。あなたはどっちタイプ？？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'聞き取りやすい話し方で、かつ笑顔で対応すると、相手にも思いやる気持ちが伝わります。')
#3
Quetion.create(title: '「すみません」をよく使う？', description: nil,
  answer1: 'NO：謝罪の時は「申し訳ありません」を使う。', answer2: 'YES：悪い事はしていないのに、よく使う。', answer3: nil,
  point1:2, point2:0, point3:1, category:'kaiwa', note:'「すみません」は謝罪の言葉。多用するのはあまり印象が良くない為、注意。\n
...
気恥ずかしさから、つい下を見てしまう。', answer3: nil,
  point1:2, point2:0, point3:1, category:'kaiwa', note:'会話をするときに相手の方を見ないと、会話を受け止めてもらえていないという印象を与えてしまう。')
#5
Quetion.create(title: '話を聞くときはどんな対応をする？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'あいづちを打つ事で相手の会話を引き出して、会話をスムーズに進める事ができます')
#6
...
とにかく自分の思いを語る。', answer3: nil,
  point1:2, point2:0, point3:1, category:'kaiwa', note:'自分の事ばかりを話すのは、相手に興味がないと思われ、印象が悪くなるので注意。\n
...
Quetion.create(title: '同僚(上司、先輩など)と、仕事についての討論になりました。あなたはどう対応する？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'自分が正しいと思い込んで、かたくなに譲らないのは、相手を不快にさせるだけでなく、会話が発展しません。')
#8
Quetion.create(title: 'あたりまえだと思っている事を相手に伝える時、どんなふうに話す？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'kaiwa', note:'自分の常識が他人の常識とは限りません。
...
Quetion.create(title: '相手の言っていることに対して、どのように答える事が多い？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'kaiwa', note:'相手の話をすぐ否定するのは、相手を不快にさせる。\n
...
Quetion.create(title: '公式の場で、上司やお客様への会話は？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'kaiwa', note:'敬語は正しく使いましょう。')
...
Quetion.create(title: 'あなたの身だしなみは？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'身だしなみは第一印象を決める大事な部分。\n
清潔感を大切にしましょう')
#2
Quetion.create(title: '仕事中、特にやる事がなくなってしまいました。あなたならどうする？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'仕事は自分で見つけるもの。\n積極的に行動する事が大切。')
#3
Quetion.create(title: '公式文書のメールを書くとき宛名は？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'bunsho', note:'「殿」は目上の人が目下の人に使う言葉の為、なるべく借職名や様を使った方が良い。')
#4
Quetion.create(title: '電車内でくしゃみをしたくなってしまいました。その時あなたは？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'自分の事ばかりを考えるのではなく、社会生活では周りへの配慮が必要。')
#5
Quetion.create(title: '社内業務の依頼メールがきました。あなたは今手を離せない状況です。どうしますか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'相手の都合、状況を考えて対応する')
#6
Quetion.create(title: '合コンに来ました。目の前には初めて会う人がいます。あなたの行動は？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'第一印象は0.2秒で決まるといわれている。\n
まずは笑顔で良い印象を。')
#7
Quetion.create(title: '仕事を依頼され、自分から引き受けましたが、他の事で忙しくなってきました。どうする？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'自分で引き受けた事は、責任を持って最後まで。')
#8
Quetion.create(title: '同僚(上司、先輩など)が担当の仕事がきましたが、忙しそうにしています。あなたはどうする？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'相手の気持ちをくみ取り、先読みした行動をする。')
#9
Quetion.create(title: '平日深夜に見たいテレビ番組がある。さて、あなたの今夜の行動は？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'話題作りの情報収集は必要ですが、それで遅刻や欠席をするようでは社会人としての自覚が足りません')
...
Quetion.create(title: 'お昼時、今日の業務はほぼ終わった状況。友人が遠くへ食事に行きたいとの提案にあなたは？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'休憩を取ることは労働者の権利ですが、社内ルールは守るものです。\n時間を気にして行動しましょう。')
...
Quetion.create(title: '新年実家で過ごしたあなた。貸家へ戻ってくると年賀はがきが!!新年明けましておめでとうはいつまで通じる？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'bunsho', note:'一般的に年賀状は松の内（1月7日）までが期限とされますが、関西地方では小正月(1月15日)まで含むようです。\n
...
Quetion.create(title: '新年に長期休暇を過ごしたあなた。1月17日に貸家へ戻ってくると年賀はがきが!!新年の挨拶は？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'bunsho', note:'寒中見舞いは年賀状の出し忘れ、喪中にもらった年賀はがきの返信、喪中の方への挨拶に使用します。\n使用時期は小寒（1月6日頃）→大寒（1月20日頃）→立春（2月4日頃）の間で使用できます。')
#3
Quetion.create(title: '彼女・彼氏との待ち合わせ。少し早めに起きたあなた。待ち合わせ場所へ赴くあなたの心境は？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'時間に余裕を持って待ち合わせ場所に行くと、相手にいい印象を与えることができます。\nただし、あまり早すぎると気を使わせてしまうので注意。')
#4
...
どれを使いますか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'追いオリーブオイルは大切です。')
#8
Quetion.create(title: '服装には気を使う方ですか？
', description: nil,
  answer1: '流行雑誌などを、こまめにチェックしたり、清潔な服装をこころがけています', answer2: '服装の基準は、とにかく”安い”ことだ', answer3: '毎日、同じ服です',
  point1:2, point2:0, point3:1, category:'koudou', note:'必ずおしゃれである必要はありませんが、清潔感は大切です。\n気をつけましょう。')
#9
Quetion.create(title: 'さりげない気遣いはできていますか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'相手がどう思うかを考えるだけで、言動や行動は変わってきます。\n常にアンテナを張って、気配りの出来る人になりましょう')
#30
Quetion.create(title: '夢や熱く語れる何かを持っていますか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'夢を持つことは、行動を起こすための糧になります。\n
積極的に持つようにしましょう。')
...
Quetion.create(title: '「実は私・・・」と言える特技がありますか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'koudou', note:'特技が仕事につながらなくても、自分の長所になります。\n何か身につけておくと役に立つこともありますよ。')
...
Quetion.create(title: 'メールで自分の意思を伝える場合、どのように書くのが良いと思いますか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'bunsho', note:'肯定文のほうが、頭にすんなり入ります。否定文は最後まで読まないと意味が分かりません。')
...
Quetion.create(title: '相手の行動を促す場合、どのように書くのが良いと思いますか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'bunsho', note:'相手の行動を促すような場合には、｢してほしくないこと｣を書くよりも、｢してほしいこと｣をストレートに肯定文で書く方が効果的であるといえるでしょう。')
...
Quetion.create(title: '用件を伝えるメールの書きだしは、どちらが良いと思いますか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'bunsho', note:'書き出しの部分で、相手に対する気遣いを書くことでビジネスライク過ぎないようにする。')

#7
Quetion.create(title: 'ビジネスで送るメールの件名は、どのように書くのが良いと思いますか？', description: nil,
  answer1: '○月△日の商談の件', answer2: '無題', answer3: '先日の件',
  point1:2, point2:0, point3:1, category:'bunsho', note:'漠然としたものではなく、件名を見ただけで、ある程度内容がイメージできるものにするのがよいでしょう。')

#8
Quetion.create(title: 'どちらの書き方が相手に与える印象が良いと思いますか？', description: nil,
  answer1: 'できるだけ頑張ってみます。', answer2: '無理かもしれません。', answer3: '',
  point1:2, point2:0, point3:1, category:'bunsho', note:'日頃からマイナス言葉はなるべく使わないようにし、プラス言葉に置き換えて使うようにしよう。')
...
Quetion.create(title: '慣用句は正しく使えていますか？間違いやすい慣用句の例です。どちらが正しいですか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'bunsho', note:'慣用句が正しく使えないと、社会人としての常識を疑われかねません。')
...
Quetion.create(title: '敬語は正しく使えていますか？どちらの使い方が正しいですか？', description: nil,
  ...
  point1:2, point2:0, point3:1, category:'bunsho', note:'「ご苦労様」は上司が部下に対して使う言葉。上司や同僚に対して使う場合は「お疲れ様」が正解です。')

#8
Quetion.create(title: '敬語は正しく使えていますか？どちらの使い方が正しいですか？', description: nil,
  answer1: 'もしよろしければお聞きになりますか？', answer2: 'もしよろしければ拝聴されますか？', answer3: '',
  point1:2, point2:0, point3:1, category:'bunsho', note:'「拝聴する」は謙譲語なので尊敬後の「お聞きになる」が正解です。')

#9
Quetion.create(title: 'この日本語の使い方はどちらが正しいですか？', description: nil,
  answer1: 'ぜひ〇〇してください。', answer2: 'ぜひ〇〇しないでください。', answer3: '',
  point1:2, point2:0, point3:1, category:'bunsho', note:'副詞「ぜひ」は肯定文で受けるのが慣用ルールなのに、否定文で受けているのがおかしいです。')

#50
Quetion.create(title: 'この日本語の使い方はどちらが正しいですか？', description: nil,
  answer1: '絶対に〇〇しないでください。', answer2: '絶対に〇〇してください。', answer3: '',
  point1:2, point2:0, point3:1, category:'bunsho', note:'副詞「絶対に」は否定文で受けるのが慣用ルールなのに、肯定文で受けているのがおかしいです。')
